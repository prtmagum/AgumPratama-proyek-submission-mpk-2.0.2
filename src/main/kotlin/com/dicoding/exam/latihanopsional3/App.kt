...
fun manipulateString(str: String, int: Int): String {
    ...
    val multiplier = if (numberInString.isNotEmpty()) numberInString.toInt() * int else int
    return if (numberInString.isNotEmpty()) str.replace(numberInString, (numberInString.toInt() * int).toString()) else "$str$multiplier"
}
